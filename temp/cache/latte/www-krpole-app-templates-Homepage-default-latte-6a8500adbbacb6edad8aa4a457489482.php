<?php
// source: C:\wamp\www\krpole\app/templates/Homepage/default.latte

// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('1794201086', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block content
//
if (!function_exists($_b->blocks['content'][] = '_lb93d6d08c8b_content')) { function _lb93d6d08c8b_content($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
?><div id="banner">
...
// block title
//
if (!function_exists($_b->blocks['title'][] = '_lb92bb43b64f_title')) { function _lb92bb43b64f_title($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block scripts
//
if (!function_exists($_b->blocks['scripts'][] = '_lbdc82209def_scripts')) { function _lbdc82209def_scripts($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block head
//
if (!function_exists($_b->blocks['head'][] = '_lb980af41e65_head')) { function _lb980af41e65_head($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
?><style>
