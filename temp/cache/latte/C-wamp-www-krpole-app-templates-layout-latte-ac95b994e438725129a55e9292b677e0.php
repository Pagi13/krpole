<?php
// source: C:\wamp\www\krpole\app/templates/@layout.latte

// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('4372814449', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block head
//
if (!function_exists($_b->blocks['head'][] = '_lb61699691f9_head')) { function _lb61699691f9_head($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
;
}}
...
// block scripts
//
if (!function_exists($_b->blocks['scripts'][] = '_lb0df83743f1_scripts')) { function _lb0df83743f1_scripts($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
